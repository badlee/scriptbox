...
obj.prototype = {
	extend : null // remove extend to Object
};
var utils = new obj();
var isArray;
...
utils.keys = function (obj) {
  ...
  return utils.map(obj, function (v, k) {
    return k;
  });
};
 ...
 */
utils.throwError = function (message, line, file) {
  if (line) {
